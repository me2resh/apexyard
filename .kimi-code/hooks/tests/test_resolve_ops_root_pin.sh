...
# .apexyard/hooks/_lib-ops-root.sh in apexyard#381, plus a tiny
# functional check on .apexyard/hooks/pin-ops-root.sh itself.
#
# Each case:
...
LIB="$SRC_ROOT/.apexyard/hooks/_lib-ops-root.sh"
HOOK="$SRC_ROOT/.apexyard/hooks/pin-ops-root.sh"
