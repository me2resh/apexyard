...
#
# Usage: bash .apexyard/hooks/tests/test_subpack_extraction.sh
...
AUDIT_EXPECTED=(
  ".apexyard/skills/launch-check/SKILL.md"
  ".apexyard/skills/launch-check/render-trend.sh"
  ".apexyard/skills/seo-audit/SKILL.md"
  ".apexyard/skills/geo-audit/SKILL.md"
  ".apexyard/skills/accessibility-audit/SKILL.md"
  ".apexyard/skills/compliance-check/SKILL.md"
  ".apexyard/skills/analytics-audit/SKILL.md"
  ".apexyard/skills/monitoring-audit/SKILL.md"
  ".apexyard/skills/docs-audit/SKILL.md"
  ".apexyard/skills/performance-audit/SKILL.md"
  ".apexyard/hooks/_lib-audit-history.sh"
  ".apexyard/hooks/_lib-read-config.sh"
  ".apexyard/hooks/_lib-ops-root.sh"
  ".apexyard/registries/ai-crawlers.json"
...
SAFETY_EXPECTED=(
  ".apexyard/hooks/check-secrets.sh"
  ".apexyard/hooks/block-main-push.sh"
  ".apexyard/hooks/block-git-add-all.sh"
  ".apexyard/hooks/pre-push-gate.sh"
  ".apexyard/hooks/verify-commit-refs.sh"
  ".apexyard/hooks/validate-pr-create.sh"
  ".apexyard/hooks/validate-branch-name.sh"
  ".apexyard/hooks/_lib-tracker.sh"
  ".apexyard/hooks/_lib-read-config.sh"
  ".apexyard/hooks/_lib-ops-root.sh"
  ".apexyard/hooks/_lib-extract-pr.sh"
  "EXTRACTION_MANIFEST.json"
)
...
for path in \
  ...
  "$REAL_SAFETY/.apexyard/settings.snippet.json"; do
  if [ ! -f "$path" ]; then
...
mkdir -p "$PLANT_DIR/audit-pack/.apexyard/skills/handover"
echo "# planted framework-distinctive file" > "$PLANT_DIR/audit-pack/.apexyard/skills/handover/SKILL.md"
