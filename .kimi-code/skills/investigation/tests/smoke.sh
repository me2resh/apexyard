...
. "$ops_root/.apexyard/hooks/_lib-portfolio-paths.sh"
...
mkdir -p "$fixture_root/fork/.apexyard/hooks"
...
cat > "$fixture_root/fork/.apexyard/project-config.json" <<JSON
{
  "portfolio": {
...
cp "$ops_root/.apexyard/project-config.defaults.json" "$fixture_root/fork/.apexyard/project-config.defaults.json"
...
cp "$ops_root/.apexyard/hooks/_lib-read-config.sh"        "$fixture_root/fork/.apexyard/hooks/"
cp "$ops_root/.apexyard/hooks/_lib-portfolio-paths.sh"    "$fixture_root/fork/.apexyard/hooks/"
...
defaults_json="$ops_root/.apexyard/project-config.defaults.json"
...
skill_md="$ops_root/.apexyard/skills/investigation/SKILL.md"
