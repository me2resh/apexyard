...
- `.apexyard/skills/update/SKILL.md` — the inverse skill, used by adopters pulling new releases into their fork
- `.apexyard/skills/release-sync/SKILL.md` — the mandatory follow-up skill that syncs main back to dev after every release, preventing squash-divergence accumulation
