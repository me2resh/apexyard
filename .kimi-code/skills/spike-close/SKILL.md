...
- Otherwise read the active-ticket marker (`.apexyard/session/current-ticket` or `.apexyard/session/tickets/<project>`) and use the ticket recorded there. If neither resolves, ask:
