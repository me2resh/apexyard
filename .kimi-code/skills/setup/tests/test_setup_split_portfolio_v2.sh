...
#
#   - All 7 v2 portfolio.* config keys land in .apexyard/project-config.json
...
build_pre_setup_v2() {
  local sb="$1"
  mkdir -p "$sb/public/.apexyard/hooks" "$sb/public/.claude"
...
# Mirrors the bash blocks in `.apexyard/skills/setup/SKILL.md` § Step 2b
...
PCONFIG="$SB/public/.apexyard/project-config.json"
