...
#   9. AI-crawler registry exists at .apexyard/registries/ai-crawlers.json,
...
SKILL="$ops_root/.apexyard/skills/geo-audit/SKILL.md"
AGDR="$ops_root/docs/agdr/AgDR-0043-geo-audit-skill.md"
REGISTRY="$ops_root/.apexyard/registries/ai-crawlers.json"
TEMPLATE="$ops_root/templates/audits/geo-audit.md"
SEO_SKILL="$ops_root/.apexyard/skills/seo-audit/SKILL.md"
LAUNCH_SKILL="$ops_root/.apexyard/skills/launch-check/SKILL.md"
...
assert_grep "Names the registry file"   "\\.apexyard/registries/ai-crawlers\\.json" "$SKILL"
