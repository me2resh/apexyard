...
```bash
bash .apexyard/skills/feature-diagram/tests/smoke.sh
```
...
bash .apexyard/skills/feature-diagram/generate.sh path/to/feature-inventory.md create-order curios-dog

# Lint a generated file
bash .apexyard/skills/feature-diagram/lint.sh projects/curios-dog/features/create-order.md
```
