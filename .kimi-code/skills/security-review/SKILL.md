...
1. **Primary reviewer**: the **Security Reviewer agent (Shield)** at [`.apexyard/agents/security-reviewer.md`](../../agents/security-reviewer.md) — runs the automated security checklist.
