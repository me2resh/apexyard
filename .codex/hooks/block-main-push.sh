...
# `.codex/project-config.json` → `.git.protected_branches[]`.
#
...
All changes must go through a PR (.codex/rules/git-conventions.md
...
Customise (rare): .codex/project-config.json → .git.protected_branches[]
