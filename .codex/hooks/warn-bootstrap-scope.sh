...
# exemption marker is active (.codex/session/active-bootstrap) but the
...
#
# Resolution: .codex/rules/workflow-gates.md § Bootstrap-skill exemption
# and .agents/skills/handover/SKILL.md § "Bootstrap scope".
#
...
MARKER="$REPO_ROOT/.codex/session/active-bootstrap"
if [ ! -f "$MARKER" ]; then
  exit 0
fi
