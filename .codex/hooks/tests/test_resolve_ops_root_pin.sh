...
# .codex/hooks/_lib-ops-root.sh in apexyard#381, plus a tiny
# functional check on .codex/hooks/pin-ops-root.sh itself.
#
# Each case:
...
LIB="$SRC_ROOT/.codex/hooks/_lib-ops-root.sh"
HOOK="$SRC_ROOT/.codex/hooks/pin-ops-root.sh"
