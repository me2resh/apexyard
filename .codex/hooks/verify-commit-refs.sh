...
#
# Backstop for the ticket-vocabulary rule (.codex/rules/ticket-vocabulary.md).
...
#   1. .codex/project-config.json `.tracker_repo`
...
#   - CONFIG_ROOT: the ops fork holding .codex/project-config.json. When
...
TRACKER_REPO=""
if [ -n "$CONFIG_ROOT" ] && [ -f "${CONFIG_ROOT}/.codex/project-config.json" ]; then
...
real issue behind them. See .codex/rules/ticket-vocabulary.md.
