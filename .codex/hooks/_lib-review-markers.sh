...
# WHY THIS EXISTS
# ---------------
# Review markers (.codex/session/reviews/<qualifier>-<role>.approved) were
...
#       resolved MARKER_HOME/.codex/session/reviews/ directory. Exits with
...
#       <marker_home>/.codex/session/reviews
#
...
# review_markers_dir <marker_home>
# Returns the path: <marker_home>/.codex/session/reviews
review_markers_dir() {
  local marker_home="${1:-.}"
  printf '%s/.codex/session/reviews' "$marker_home"
}
