# `.codex/migrations/` — per-release migration scripts
...
The chain walker (`.codex/hooks/_lib-migration-chain.sh`) discovers pair scripts by globbing this directory; the filenames ARE the chain.
...
- Adding default keys to `.codex/project-config.json`
