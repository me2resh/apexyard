...
- Otherwise read the active-ticket marker (`.codex/session/current-ticket` or `.codex/session/tickets/<project>`) and use the ticket recorded there. If neither resolves, ask:
