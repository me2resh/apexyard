...
#
# The skill itself runs inside Codex (interactive interview, gh issue
...
. "$ops_root/.codex/hooks/_lib-portfolio-paths.sh"
...
mkdir -p "$fixture_root/fork/.codex/hooks"
...
cat > "$fixture_root/fork/.codex/project-config.json" <<JSON
{
  "portfolio": {
...
cp "$ops_root/.codex/project-config.defaults.json" "$fixture_root/fork/.codex/project-config.defaults.json"
...
cp "$ops_root/.codex/hooks/_lib-read-config.sh"        "$fixture_root/fork/.codex/hooks/"
cp "$ops_root/.codex/hooks/_lib-portfolio-paths.sh"    "$fixture_root/fork/.codex/hooks/"
...
defaults_json="$ops_root/.codex/project-config.defaults.json"
...
skill_md="$ops_root/.agents/skills/investigation/SKILL.md"
