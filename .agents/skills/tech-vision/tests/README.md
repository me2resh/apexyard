...
`/tech-vision` skill without spinning up an interactive Codex session:
...
The skill itself runs inside Codex with the interactive interview flow —
...
```bash
bash .agents/skills/tech-vision/tests/smoke.sh
```
