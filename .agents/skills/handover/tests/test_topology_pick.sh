...
#  15. AGENTS.md QUICK REFERENCE table includes a `topologies/` row
...
HANDOVER_SKILL="$SRC_ROOT/.agents/skills/handover/SKILL.md"
UPDATE_SKILL="$SRC_ROOT/.agents/skills/update/SKILL.md"
...
# 15. AGENTS.md QUICK REFERENCE has topologies/ row
if grep -q "topologies/" "$CLAUDE_MD"; then
  pass "AGENTS.md mentions topologies/"
else
  fail "AGENTS.md missing topologies/ reference"
fi
