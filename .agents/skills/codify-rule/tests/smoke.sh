...
# AgDR rationale, the AGENTS.md skill table, the docs/multi-project.md
# table, and the handbooks/ convention. The skill itself runs inside
# Codex (interactive interview, file write); this smoke test pins
...
#      (Stage 1).
#   8. AGENTS.md skill table contains the /codify-rule row and the count
#      bumped to 51.
...
skill_md="$ops_root/.agents/skills/codify-rule/SKILL.md"
agdr_md="$ops_root/docs/agdr/AgDR-0040-codify-rule-skill.md"
claude_md="$ops_root/AGENTS.md"
...
# ---------------------------------------------------------------------------
# 9. AGENTS.md skill table updated to 51 + /codify-rule row present
# ---------------------------------------------------------------------------
echo ""
echo "9. AGENTS.md skill table updates:"
