...
1. **Primary reviewer**: the **Security Reviewer agent (Shield)** at [`.codex/agents/security-reviewer.toml`](../../agents/security-reviewer.md) — runs the automated security checklist.
