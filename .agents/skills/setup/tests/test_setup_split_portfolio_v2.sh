...
#
#   - All 7 v2 portfolio.* config keys land in .codex/project-config.json
...
build_pre_setup_v2() {
  local sb="$1"
  mkdir -p "$sb/public/.codex/hooks" "$sb/public/.claude"
...
# Mirrors the bash blocks in `.agents/skills/setup/SKILL.md` § Step 2b
...
PCONFIG="$SB/public/.codex/project-config.json"
