...
1. **Primary reviewer**: the **Code Reviewer agent (Rex)** at [`.codex/agents/code-reviewer.toml`](../../agents/code-reviewer.md) — runs on every commit, owns the automated first-pass review.
