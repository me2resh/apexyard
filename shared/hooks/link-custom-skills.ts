#!/usr/bin/env bun
/**
 * link-custom-skills hook — auto-generated wrapper.
 *
 * Wraps the original bash implementation in .claude/hooks/link-custom-skills.sh as an
...
export default link_custom_skills
