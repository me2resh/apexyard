...
- Tests: `.claude/hooks/tests/test_require_posted_review.sh` (15 cases, both directions; every fail-open shape is mutation-verified — reverting a fix drops the suite by exactly the case that names it)
