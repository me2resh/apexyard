...
| Rules | `.claude/rules/` | 14 modular rule files (AgDR triggers, code standards, git conventions, isolated builds, leak protection, loop mode, parallel work, plan mode, PR quality, PR workflow, reporting style, role triggers, ticket vocabulary, workflow gates) |
