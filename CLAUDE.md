...
| Skills | `.claude/skills/` | 61 slash commands — see the full list below |
...
| `/ui-ux-pro-max` | UI/UX design intelligence for planning, building, reviewing, and polishing frontend interfaces |
| `/graphify` | Turn any folder into a navigable knowledge graph — community detection, audit trail, interactive HTML, GraphRAG-ready JSON. Foundational: installed on every project. |
...
| Skills (61 slash commands, incl. `/graphify`) | `.claude/skills/` |
