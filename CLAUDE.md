...
| Rules | `.claude/rules/` | 13 modular rule files (AgDR triggers, code standards, git conventions, leak protection, loop mode, parallel work, plan mode, PR quality, PR workflow, reporting style, role triggers, ticket vocabulary, workflow gates) |
