...
description: Record per-PR architecture-review approval for design-artifact PRs (required by the architecture gate).
argument-hint: "<pr-number>"
---

# /approve-architecture — Record Per-PR Architecture-Review Approval
