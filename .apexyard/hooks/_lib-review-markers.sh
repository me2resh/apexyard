...
# WHY THIS EXISTS
# ---------------
# Review markers (.apexyard/session/reviews/<qualifier>-<role>.approved) were
...
#       resolved MARKER_HOME/.apexyard/session/reviews/ directory. Exits with
...
#       <marker_home>/.apexyard/session/reviews
#
...
# review_markers_dir <marker_home>
# Returns the path: <marker_home>/.apexyard/session/reviews
review_markers_dir() {
  local marker_home="${1:-.}"
  printf '%s/.apexyard/session/reviews' "$marker_home"
}
