...
# .apexyard/hooks/_lib-portfolio-paths.sh + the schema validity of the
...
MD
    ...
    cp "$LIB_SRC" .apexyard/hooks/_lib-portfolio-paths.sh
    cp "$CONFIG_LIB_SRC" .apexyard/hooks/_lib-read-config.sh
