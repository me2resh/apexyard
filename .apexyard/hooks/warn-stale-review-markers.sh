...
# THE GAP THIS CLOSES
# -------------------
# Review markers at .apexyard/session/reviews/<pr>-{rex,ceo,design}.approved are
...
# MODES
# -----
# Config at .apexyard/project-config.json → review_markers.on_stale:
...
REVIEWS_DIR=$(review_markers_dir "$REPO_ROOT" 2>/dev/null || printf '%s/.apexyard/session/reviews' "$REPO_ROOT")
