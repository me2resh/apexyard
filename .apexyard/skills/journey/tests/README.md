...
```bash
python3 .apexyard/skills/journey/tests/render_smoke.py
```
...
| Input | Output |
|-------|--------|
| `.apexyard/skills/journey/fixtures/sample-checkout.yaml` | `/tmp/sample-checkout.html` |

Or pass explicit paths:

```bash
python3 .apexyard/skills/journey/tests/render_smoke.py path/to/journey.yaml /tmp/out.html
```
