...
1. **Primary reviewer**: the **Code Reviewer agent (Rex)** at [`.apexyard/agents/code-reviewer.md`](../../agents/code-reviewer.md) — runs on every commit, owns the automated first-pass review.
